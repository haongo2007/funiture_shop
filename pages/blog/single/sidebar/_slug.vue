	...
	<main class="main">
		<nav class="breadcrumb-nav">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Fullwidth With Sidebar</li>
				</ol>
			</div>
		</nav>
		...
		<div class="page-content">
			<div
				...
				:class="{loaded: loaded}"
			>
				<div class="skel-sidebar-post"></div>
				<template v-if="blog">
					<figure
						class="entry-media entry-media-sidebar"
					...
					<figure
						class="entry-media entry-media-sidebar entry-gallery"
						...
						<template v-if="blog">
							<article class="entry single-entry">
								<div class="entry-body">
									<div class="entry-meta">
										<span class="entry-author">
											by
											<nuxt-link :to="'/blog/single/default/' + blog.slug">{{blog.author}}</nuxt-link>
										</span>
									...
									>
										...
										<span
											...
											:key="index"
										>
											<nuxt-link :to="'/blog/single/default/' + blog.slug">{{ cat.name }}</nuxt-link>
									...
									<div class="entry-content editor-content">
										...
										<p>
											Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a
											<a href="#">ultrices sagittis</a>, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.
										</p>
										...
										<img
											v-lazy="'./images/blog/single/fullwidth-sidebar/4.jpg'"
											alt="image"
										/>
										<img
											v-lazy="'./images/blog/single/fullwidth-sidebar/5.jpg'"
											alt="image"
										/>
								...
								<div class="entry-author-details">
									<figure class="author-media">
										<a href="#">
											<img
												v-lazy="'./images/blog/single/author.jpg'"
												alt="User name"
											/>
										</a>
									</figure>
							...
							<nav class="pager-nav">
								<nuxt-link
									...
									:to="'/blog/single/sidebar/'+ prevBlog.slug"
									v-if="prevBlog"
								>
									Previous Post
								...
								<nuxt-link
									...
									:to="'/blog/single/sidebar/'+ nextBlog.slug"
									v-if="nextBlog"
								>
									Next Post
									...
									<li>
										<div class="comment">
											<figure class="comment-media">
												<a href="#">
													<img
														v-lazy="'./images/blog/comments/1.jpg'"
														alt="User name"
													/>
												</a>
											</figure>
											...
											<li>
												<div class="comment">
													<figure class="comment-media">
														<a href="#">
															<img
																v-lazy="'./images/blog/comments/2.jpg'"
																alt="User name"
															/>
														</a>
													</figure>
									...
									<li>
										<div class="comment">
											<figure class="comment-media">
												<a href="#">
													<img
														v-lazy="'./images/blog/comments/3.jpg'"
														alt="User name"
													/>
												</a>
											</figure>
	...
	data: function() {
		return {
			...
			carouselSettingSingle: {
				...carouselSettingSingle,
				navigation: {
					nextEl: '.entry-media-sidebar.entry-gallery .swiper-next',
					prevEl: '.entry-media-sidebar.entry-gallery .swiper-prev'
				}
			},
			carouselSetting: {
				...carouselSettingDefault,
