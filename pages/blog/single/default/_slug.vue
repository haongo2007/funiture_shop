<template>
    <main class="main">
        <page-header title="Default With Sidebar" subtitle="Single Post"></page-header>
        ...
        <nav class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Default With Sidebar</li>
                </ol>
            </div>
        </nav>
                        ...
                        <article class="entry single-entry" v-if="blog">
                            ...
                            <div class="entry-body">
                                ...
                                <div class="entry-content editor-content">
                                    ...
                                    <img v-lazy="'./images/blog/single/3.jpg'" alt="image" />
