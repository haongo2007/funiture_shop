...
import nuxt_plugin_axios_79b1b056 from 'nuxt_plugin_axios_79b1b056' // Source: ./axios.js (mode: 'all')
...
import nuxt_plugin_toastify_a40165a8 from 'nuxt_plugin_toastify_a40165a8' // Source: ../plugins/toastify.js (mode: 'client')
import nuxt_plugin_nouislider_66d8556a from 'nuxt_plugin_nouislider_66d8556a' // Source: ../plugins/nouislider.js (mode: 'client')
import nuxt_plugin_debounce_06d089d8 from 'nuxt_plugin_debounce_06d089d8' // Source: ../plugins/debounce.js (mode: 'client')
import nuxt_plugin_validate_709b3feb from 'nuxt_plugin_validate_709b3feb' // Source: ../plugins/validate.js (mode: 'client')
import nuxt_plugin_sticky_7e113cb8 from 'nuxt_plugin_sticky_7e113cb8' // Source: ../plugins/sticky.js (mode: 'client')
import nuxt_plugin_i18n_1fba523a from 'nuxt_plugin_i18n_1fba523a' // Source: ../plugins/i18n.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_axios_79b1b056 === 'function') {
    await nuxt_plugin_axios_79b1b056(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_validate_709b3feb === 'function') {
    await nuxt_plugin_validate_709b3feb(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_sticky_7e113cb8 === 'function') {
    await nuxt_plugin_sticky_7e113cb8(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_i18n_1fba523a === 'function') {
